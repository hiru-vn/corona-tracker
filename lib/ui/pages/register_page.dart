...
class _RegisterPageState extends State<RegisterPage> {
  ...
  async{
    ...
    switch (_mySelection) {
      ...
      break;
      case "Thành phố Hà Nội" :cityCode = "01";     
      break;
      ...
      case "Tỉnh Bình Phước": cityCode = "70";
      break;
      case "Tỉnh Bình Thuận" :cityCode = "60";     
      break;
      case "Tỉnh Bình Định": cityCode = "52";
      break;
      case "Tỉnh Bạc Liêu" :cityCode = "95";     
      break;
      case "Tỉnh Bắc Giang": cityCode = "24";
      break;
      case "Tỉnh Bắc Kạn" :cityCode = "06";     
      break;
      case "Tỉnh Bắc Ninh": cityCode = "27";
      break;
      case "Tỉnh Bến Tre" :cityCode = "83";     
      break;

      case "Tỉnh Cao Bằng": cityCode = "04";
      break;
      case "Tỉnh Cà Mau" :cityCode = "96";     
      break;
      case "Tỉnh Gia Lai": cityCode = "64";
      break;
      case "Tỉnh Hoà Bình" :cityCode = "17";     
      break;
      case "Tỉnh Hà Giang": cityCode = "02";
      break;
      case "Tỉnh Hà Nam" :cityCode = "35";     
      break;
      case "Tỉnh Hà Tĩnh": cityCode = "42";
      break;
      case "Tỉnh Hưng Yên" :cityCode = "33";     
      break;

      case "Tỉnh Hải Dương": cityCode = "30";
      break;
      case "Tỉnh Hậu Giang" :cityCode = "93";     
      break;
      case "Tỉnh Khánh Hòa": cityCode = "56";
      break;
      case "Tỉnh Kiên Giang" :cityCode = "91";     
      break;
      case "Tỉnh Kon Tum": cityCode = "62";
      break;
      case "Tỉnh Lai Châu" :cityCode = "12";     
      break;
      case "Tỉnh Long An": cityCode = "80";
      break;
      case "Tỉnh Lào Cai" :cityCode = "10";     
      break;

      case "Tỉnh Lâm Đồng": cityCode = "68";
      break;
      case "Tỉnh Lạng Sơn" :cityCode = "20";     
      break;
      case "Tỉnh Nam Định": cityCode = "36";
      break;
      case "Tỉnh Nghệ An" :cityCode = "40";     
      break;
      case "Tỉnh Ninh Bình": cityCode = "37";
      break;
      case "Tỉnh Sóc Trăng" :cityCode = "94";     
      break;
      case "Tỉnh Sơn La": cityCode = "14";
      break;
      case "Tỉnh Thanh Hóa" :cityCode = "38";     
      break;

      case "Tỉnh Thái Bình": cityCode = "34";
      break;
      case "Tỉnh Thái Nguyên" :cityCode = "19";     
      break;
      case "Tỉnh Thừa Thiên Huế": cityCode = "46";
      break;
      case "Tỉnh Tiền Giang" :cityCode = "82";     
      break;
      case "Tỉnh Trà Vinh": cityCode = "84";
      break;
      case "Tỉnh Tuyên Quang" :cityCode = "08";     
      break;
      case "Tỉnh Tây Ninh": cityCode = "72";
      break;
      case "Tỉnh Vĩnh Long" :cityCode = "86";     
      break;

      case "Tỉnh Vĩnh Phúc": cityCode = "26";
      break;
      case "Tỉnh Yên Bái" :cityCode = "15";     
      break;
      case "Tỉnh Điện Biên": cityCode = "11";
      break;
      case "Tỉnh Đắk Lắk" :cityCode = "66";     
      break;
      case "Tỉnh Đắk Nông": cityCode = "67";
      break;
      case "Tỉnh Đồng Nai" :cityCode = "75";     
      break;
      case "Tỉnh Đồng Tháp": cityCode = "87";
      break;
        break;
      default:
    }
